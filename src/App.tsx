  ...
  return (
    <div className="flex flex-col gap-10 overflow-x-hidden">
      <motion.section
        ...
        initial="hidden"
        animate="show"
        className="grid grid-cols-1 md:grid-cols-3 p-10 gap-10"
      >
        {/* Fade Up */}
        <motion.div
        ...
        >
          <motion.div
            ...
            transition={{ duration: 5, ease: 'easeInOut', repeat: Infinity, repeatDelay: .5 }}
          />
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-slate-800 aspect-square rounded-lg justify-center flex items-center gap-10">
          <motion.div
            className="w-1/3 h-1/3 bg-orange-500 cursor-grab rounded-2xl"
            drag
      ...
      <section ref={containRef} className="flex flex-col gap-10 mb-20">
        <motion.h1
        ...
        <motion.p style={{ translateX: paragraphOneValue }} className="text-slate-100 font-thin text-xl md:text-4xl md:w-1/4 mx-auto">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illum, sint quas, molestias in deleniti recusandae totam veniam ratione dolore iusto voluptatem dicta autem dignissimos corrupti.</motion.p>
        <motion.p style={{ translateX: paragraphTwoValue }} className="text-slate-100 font-thin text-xl md:text-4xl md:w-1/4 mx-auto">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illum, sint quas, molestias in deleniti recusandae totam veniam ratione dolore iusto voluptatem dicta autem dignissimos corrupti.</motion.p>
      </section>
    </div >
  )
}
